...
desp_dict = {'rcc': ['RClone is a command-line program to sync files and directories to and from different cloud storage providers like GDrive, OneDrive...', 'Send rclone.conf. \n<b>Timeout:</b> 60 sec'],
            ...
            'lrename': ['Auto Rename Format (Filename Template). Use variables like {name} {season}{episode} {year} {resolution} {quality} {shortlang} {ott}.',
                        'Send your Auto Rename template.\nExample:\n<code>{name} {season}{episode} {year} {resolution} {quality} {shortlang} {ott}{extension}</code>\n\nTo disable send: <code>off</code>\n<b>Timeout:</b> 60 sec'],
